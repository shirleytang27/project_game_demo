...
class Ui_MainWindow(object):
    ...
    def load_form(self):
        ...
        self.txtOut1.setText('Instruction to the game:'+'\n'+ 'Once the game starts, the system will form two teams automatically (Team one on the left and Team two on the right) and randomly assign the roles to each team members with different amount of attributes. By clicking the hero profile, you could see the change of attributes of the hero after each attack. When a hero is dead, his profile will change. Once all 5 members from a team were killed, it will display game over.')
        self.update_blood()
